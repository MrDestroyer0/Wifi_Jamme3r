...
echo "        [ BY: Mohammad Zim | Facebook Faisal Iqbal (heart hacker) | v1.0 ]" | pv -qL 40 | lolcat
...
echo -e "                             [ BY: Mohammad Zim | Instagram: its_.error._ | v1.0 ]\n" | pv -qL 20 | lolcat
